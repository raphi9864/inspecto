...
const AuditIcon = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 11H3v10h6V11z"/><path d="M15 3h-6v18h6V3z"/><path d="M21 7h-6v14h6V7z"/><path d="M9 14l2 2 4-4"/></svg>
const GedIcon = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="8" y1="8" x2="16" y2="8"/><line x1="8" y1="12" x2="16" y2="12"/><line x1="8" y1="16" x2="13" y2="16"/></svg>
...
function useSidebarSections() {
  ...
  /* SAE-only section: rendered directly under the top (Home/Dashboard)
     block when ProductMode === 'sae'. Hidden otherwise. */
  if (mode === 'sae') {
    sections.push({
      label: t('sidebar.saeModules'),
      collapsible: true,
      items: [
        { Icon: AuditIcon, label: t('sidebar.auditWorkflow'), path: '/app/audit-workflow', demoTarget: 'sidebar-sae-audit' },
        { Icon: GedIcon, label: t('sidebar.ged'), path: '/app/ged', demoTarget: 'sidebar-sae-ged' },
      ],
    })
  }
